...
<center>
  <div style="font-size:18px;font-weight:bold;background-color:yellow;">
    Your Local Niche Spy Software Account has been created.<br /><br />Your license key is <?php echo $result; ?> (Please write this key down)<br /><br />
...
<tr>
<td width="300">
<h2 class="center">One payment of <s>$997</s> </h2>
<h2 class="center">$297 Today (Charter price)</h2>
<p class="center"><a href="http://home.rockstarpowersuite.com/?p=5cd6aca8e7"><img style="border: 0px solid; width: 300px; height: 103px;" alt="" src="https://s3.amazonaws.com/oo-scr/bridgepage/images/addtocart-nopaypal-300px.png"></a></p>
</td>
<td width="2">
<div id="divider"></div>
</td>
...
<script type="text/javascript">      
        $(document).ready(function(){
          ...
          //init plugin
          $('#fancyCountdown').fancyCountdown({year:2012, month:9, day:5, hour:19, minute:0, second:0, timezone:-4, digitUnitHeight:80, autoStart:true, callback:targetReached, digits:{days:false,hours:true,minutes:true,seconds:true}, fillColor:'#cc0000', bottomDigitOffset: 28});
...
<table align="center" border="0" cellpadding="5" cellspacing="0" width="650">
      ...
      <tr>
        ...
        <td><strong style="font-size: 30px;">$3,282.00<u> </u></strong></td>
      </tr>
  </tbody></table>
<p>&nbsp;</p>
...
<h2 class="center">One payment of <s>$997</s></h2>
<h2 class="center">$297 Today (Charter price)</h2>
<p class="center"><a href="http://home.rockstarpowersuite.com/?p=5cd6aca8e7"><img style="border: 0px solid; width: 300px; height: 103px;" alt="" src="https://s3.amazonaws.com/oo-scr/bridgepage/images/addtocart-nopaypal-300px.png" /></a></p></td>
<td width="2">
<div id="divider"></div>
</td>
