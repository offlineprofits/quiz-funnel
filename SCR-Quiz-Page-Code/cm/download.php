...
<p>&nbsp;</p>
<p class="center"><a href="http://home.rockstarpowersuite.com/?p=6a32f8d89a"><img style="border: 0px solid; width: 300px; height: 103px;" alt="" src="https://s3.amazonaws.com/oo-scr/bridgepage/images/addtocart-nopaypal-300px.png"></a></p>
</td>
<td width="2">
<div id="divider"></div>
</td>
...
<p class="center"><a href="http://home.rockstarpowersuite.com/?p=ae88156d4e"><!--target="_blank"--><img style="border: 0px solid; width: 300px; height: 103px;" alt="" src="https://s3.amazonaws.com/oo-scr/bridgepage/images/addtocart-nopaypal-300px.png"></a></p>
</td>
</tr>
</tbody>
</table>
...
<script type="text/javascript">      
        $(document).ready(function(){
          ...
          //init plugin
          $('#fancyCountdown').fancyCountdown({year:2012, month:10, day:8, hour:23, minute:59, second:59, timezone:-7, digitUnitHeight:80, autoStart:true, callback:targetReached, digits:{days:true,hours:true,minutes:true,seconds:true}, fillColor:'#cc0000', bottomDigitOffset: 28});
      ...
      function targetReached() {
        ...
        $('#fastmover2').hide();
        $("a[href='http://home.rockstarpowersuite.com/?p=6a32f8d89a']").attr('href', 'http://home.rockstarpowersuite.com/?p=bc4793c33a')
        };
