...
<h2 class="center">Application Fee of <br>
  $99 Today
  <br />
  <span style="font-size:12pt">Once Accepted, you will be charged Just 2 additional payments of $199 but 30 days apart, plus optional $67/mo starting in 90 days</span></h2>
<p>&nbsp;</p>
<p class="center"><a href="https://lifehelp.infusionsoft.com/go/htf/ht/"><img style="border: 0px solid; width: 300px; height: 103px;" alt="" src="https://s3.amazonaws.com/oo-scr/bridgepage/images/addtocart-nopaypal-300px.png"></a></p>
</td>
<td width="2">
<div id="divider"></div>
</td>
...
<h1>Kickstarter</h1>
<h2>&nbsp;</h2>
<h2><span class="center">Application Fee of <br />
  $99 Today</span><br />
  <span class="center"><span style="font-size:12pt">Once Accepted, you will be charged Just 1 additional payments of $99, plus optional $67/mo starting in 90 days</span></span></h2>
<p>&nbsp;</p>
<p class="center"><a href="https://lifehelp.infusionsoft.com/go/htk/ht/"><!--target="_blank"--><img style="border: 0px solid; width: 300px; height: 103px;" alt="" src="https://s3.amazonaws.com/oo-scr/bridgepage/images/addtocart-nopaypal-300px.png"></a></p>
</td>
</tr>
</tbody>
</table>
...
<script type="text/javascript">      
        $(document).ready(function(){
          ...
          //init plugin
          $('#fancyCountdown').fancyCountdown({year:2012, month:10, day:12, hour:23, minute:59, second:59, timezone:-7, digitUnitHeight:80, autoStart:true, callback:targetReached, digits:{days:true,hours:true,minutes:true,seconds:true}, fillColor:'#cc0000', bottomDigitOffset: 28});
      ...
      function targetReached() {
        ...
        $('#fastmover2').hide();
        $("a[href='http://home.rockstarpowersuite.com/?p=3fc86a1629']").attr('href', 'http://home.rockstarpowersuite.com/?p=fd16e92b58')
        };
