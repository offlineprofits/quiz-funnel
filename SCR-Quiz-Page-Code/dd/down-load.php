  ...
  <div class="pricetable-inner">
      ...
      <div class="pricetable-column-wall">
        ...
        <ul class="features">
                    ...
                    <li >
                        Bonus 2 - Income Growth                      </li>
                    <li >
                        Bonus 3 - Client Attraction                      </li>
                    <li >
                        Bonus 4 - Black OPs NLP                      </li>
                    <li >
                        Bonus 5 - Proposals                      </li>
                    <li >
                        Bonus 6 - Facebook Group                      </li>
                    <li >
                        Bonus 7 - Credibiity Kit                      </li>
                    <li >
                        Bonus 8 - Pro Website                      </li>
                            </ul>
        <div class="ribbon">HOT</div>
                <div class="pricetable-button-container"> <a href="#">Select</a> </div>
              </div>
    </div>
          <div class="pricetable-column " style="width:25%">
      <div class="pricetable-column-wall">
        <div class="pricetable-header">
          ...
          <div class="pricetable-header-inner">
            <div class="pricetable-fld-price"><span class="cur"></span>$97</div>
            <p>$97 x 2 payments</p>
                      </div>
        </div>
        <ul class="features">
                              <li >
                        &nbsp;<div class='yn_basic ni'></div>                      </li>
                    <li >
                        &nbsp;<div class='yn_basic ni'></div>                      </li>
                    <li >
                        (4) Four                      </li>
        ...
        <div class="ribbon">HOT</div>
                <div class="pricetable-button-container"> <a href="http://home.rockstarpowersuite.com/?p=551f5c25db">Select</a> </div>
              </div>
    </div>
          <div class="pricetable-column highlight" style="width:25%">
      <div class="pricetable-column-wall">
        <div class="pricetable-header">
          <div class="pricetable-fld-name">Standard Split Payment</div>
          <div class="pricetable-header-inner">
            <div class="pricetable-fld-price"><span class="cur"></span>$197</div>
            <p>$197 x 3 Payments</p>
                        <div class="ribbon-wrapper-green"><div class="ribbon-green">Best Deal</div></div>
                      </div>
        </div>
        <ul class="features">
                              <li >
                    ...
                    <li >
                        &nbsp;<div class='yn_basic yi'></div>                      </li>
                    <li class="hasToolTip">
                        &nbsp;<div class='yn_basic yi'></div>                        <small>90 Day Trial Included</small>
                      </li>
                    <li class="hasToolTip">
                        &nbsp;<div class='yn_basic yi'></div>                        <small>90 Day Trial Included</small>
                      </li>
        ...
        <div class="ribbon">HOT</div>
                <div class="pricetable-button-container"> <a href="http://home.rockstarpowersuite.com/?p=1312cae030">Top Choice</a> </div>
              </div>
    </div>
          <div class="pricetable-column " style="width:25%">
      <div class="pricetable-column-wall">
        <div class="pricetable-header">
          <div class="pricetable-fld-name">Standard Single Payment</div>
          <div class="pricetable-header-inner">
            <div class="pricetable-fld-price"><span class="cur"></span>$497</div>
            <p>Single Payment</p>
                      </div>
        </div>
        <ul class="features">
        ...
        <div class="ribbon">HOT</div>
                <div class="pricetable-button-container"> <a href="http://home.rockstarpowersuite.com/?p=3d212a5918">Select</a> </div>
              </div>
    </div>
...
<script type="text/javascript">      
        $(document).ready(function(){
          ...
          //init plugin
          $('#fancyCountdown').fancyCountdown({year:2012, month:10, day:11, hour:23, minute:59, second:59, timezone:-7, digitUnitHeight:80, autoStart:true, callback:targetReached, digits:{days:true,hours:true,minutes:true,seconds:true}, fillColor:'#cc0000', bottomDigitOffset: 28});
      ...
      function targetReached() {
        ...
        $('#fastmover2').hide();
        $("a[href='http://home.rockstarpowersuite.com/?p=3d212a5918']").attr('href', 'http://home.rockstarpowersuite.com/?p=1e87531fd8')
        };
