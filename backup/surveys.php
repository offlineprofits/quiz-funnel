...
if($id == null){
	...
	$layout->AddContentById('categories', $layout->GetContent('survey-edit-category'));
...
if($id != null){
	...
	$categories = $db->get_results("SELECT * FROM " . TABLES_PREFIX . "taker_categories WHERE survey_id = $id ORDER BY id ASC");
